    ...
    public long solution(int cap, int n, int[] deliveries, int[] pickups) {
        ...
        while (!deliveryStack.isEmpty() || !pickupStack.isEmpty()) {
            if (!deliveryStack.isEmpty()) {
                deliveryLength = deliveryStack.peek() + 1;
            }
            ...
            while (!deliveryStack.isEmpty()) {
                ...
                if (deliveryCap - deliveries[delivery] >= 0) {
                    deliveryCap = deliveryCap - deliveries[delivery];
            ...
            if (!pickupStack.isEmpty()) {
                pickupLength = pickupStack.peek() + 1;
            }
            ...
            while (!pickupStack.isEmpty()) {
                ...
                if (pickupCap - pickups[pickup] >= 0) {
                    pickupCap = pickupCap - pickups[pickup];
...
//                 if (curCap + pickups[pickup] <= cap) {
//                     curCap = curCap + pickups[pickup];
                    
//                     if (curCap == cap) {
//                         break;
//                     }
//                 } else {
//                     pickups[pickup] -= cap - curCap;
//                     pickupStack.push(pickup);
//                     curCap = cap;
//                     break;
//                 }
